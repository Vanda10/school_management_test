<template>
    <div class="sidebar fixed top-0 bottom-0 lg:left-0 md:left-0 p-2 w-[300px] overflow-y-auto text-center bg-[#183D5C]">
      ...
      <div class="p-2.5 mt-3 flex items-center rounded-md px-4 hover:bg-sky-900 text-gray-100">
        <router-link to="/">
      ...
      <div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 hover:bg-sky-900 text-gray-100"
      ...
      <div
        ...
        <h1 id="all-teachers" class="p-2 hover:bg-sky-900 rounded-md mt-1">
          <router-link to="/all-teacher">
            <i class="bi bi-caret-right-fill"></i>
            All teachers
          </router-link>
        </h1>
        <h1 id="add-teacher" class="p-2 hover:bg-sky-900 rounded-md mt-1">
      ...
      <div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 hover:bg-sky-900 text-gray-100" @click="toggleDropdown('student')">
      ...
      <div
        v-if="student"
        class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-100 font-bold">
        <h1 class="p-2 hover:bg-sky-900 rounded-md mt-1">
      ...
      <div class="p-2.5 mt-3 flex items-center rounded-md px-4 hover:bg-sky-900 text-gray-100" @click="toggleDropdown('classes')">
      ...
      <div class="p-2.5 mt-3 flex items-center rounded-md px-4 hover:bg-sky-900 text-gray-100" @click="toggleDropdown('courses')">
